    ...
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-zinc-500">Start recovering trapped storage spend in minutes.</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-zinc-900 rounded-xl border border-zinc-800 p-8 space-y-4">
          ...
          <div>
            ...
            <input name="name" type="text" required className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-lime-500" placeholder="Your name" />
          </div>
          <div>
          ...
          <div>
            ...
            <input name="password" type="password" required minLength={8} className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-lime-500" />
          </div>
          ...
          <p className="text-center text-zinc-400 text-sm">
            Already have an account? <Link href="/auth/sign-in" className="text-lime-400 hover:text-lime-300">Sign in</Link>
          </p>
        </form>
      </div>
    </main>
